...
export default function ContractorWikiPage() {
    ...
    <div className="container mx-auto pb-16">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between mb-6">
        <h1 className="text-3xl font-bold tracking-tight">
          {language === 'en' ? 'Contractor User Guide' : 'Guide Utilisateur - Entrepreneur'}
        </h1>
        <Badge variant="outline" className="mt-2 md:mt-0 text-sm md:text-base px-3 py-1 border-primary text-primary">
          {language === 'en' ? 'ROLE: CONTRACTOR' : 'RÔLE: ENTREPRENEUR'}
        </Badge>
      </div>
          ...
          <Card>
            ...
            <CardContent>
              <div className="flex flex-col items-center justify-center text-center p-6">
                <HardHat className="h-16 w-16 text-orange-500 mb-4" />
                <h2 className="text-xl font-medium mb-2">
                  {language === 'en' ? 'Coming Soon' : 'Bientôt disponible'}
                </h2>
                <p className="text-muted-foreground max-w-md">
                  {language === 'en' 
                    ? 'The Contractor wiki page is currently under development. Please check back later for comprehensive documentation on contractor access and services.'
                    : 'La page wiki de l\'Entrepreneur est actuellement en développement. Veuillez revenir plus tard pour une documentation complète sur l\'accès et les services des entrepreneurs.'}
                </p>
              </div>
            </CardContent>
          </Card>
